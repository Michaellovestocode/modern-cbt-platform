                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex gap-2">
                                <a href="<?php echo e(route('admin.subjects.edit', $subject->id)); ?>" class="text-blue-600 hover:text-blue-900 font-medium text-sm">
                                    Edit
                                </a>
                                <a href="<?php echo e(route('admin.subjects.assign-teachers', $subject->id)); ?>" class="text-purple-600 hover:text-purple-900 font-medium text-sm">
                                    Teachers
                                </a>
