...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-lg shadow p-8">
        ...
        <form action="<?php echo e(route('admin.student.update', $student->id)); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\cbt-update\modern-cbt-platform-for-highschool\resources\views/admin/students/edit.blade.php ENDPATH**/ ?>